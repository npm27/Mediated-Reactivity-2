...
<form id="content" class="basicInfo" name="Demographics"
    ...
    <fieldset>
        ...
        <section class="consent">
            ...
            <textarea readonly>The purpose of this study is to examine the percieved relatedness between words. You will be shown words pairs presented on a computer screen and will be asked to complete a judgment task involving the words. The experiment will take approximately 15 minutes to complete and you will be compensated at a rate of $2.00/15 minute session. The researchers do not expect any risks from participating in this study other than the possibility of slight boredom during task completion. Your participation will be kept confidential. You are free to discontinue at anytime by simply closing your browser window. Your data will be deleted immediately after you withdraw. This project and the consent form have been reviewed by the Institutional Review Board at Midwestern State University. Any questions should be directed to nicholas.maxwell@msutexas.edu</textarea>
            <label>
